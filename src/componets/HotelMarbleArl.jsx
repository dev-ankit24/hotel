...
export default function HotelMarbleArl() {
      ...
      {/* <div className="container-fluid page-header mb-1 p-0" style={{ backgroundImage: "url(/img/room/marbel/6.jpg)" }}>
        <div className="container-fluid  py-5">
          <div className="container text-center pb-5">
            <h1 className="  mb-3 animated slideInDown" style={{color:"#B37E48"}}>Hotel Marble ARL</h1>
          </div>
        </div>
      </div> */}
  ...
  <div className="container hotel-main">
   ...
   <div className="container hotel-main mt-5 mb-5">
        <div className="text-center">
          <h2 className="mb-3">About Hotel Marble ARL </h2>
          <div className="hotel-siam-line m-auto mb-3"></div>
          <p className="mx-auto" style={{ maxWidth: "1000px" }}>
           
            Welcome to <strong>Hotel Marble ARL </strong> by <strong>Tomar Hospitality</strong>, where comfort meets elegance. Located in the heart of the city,
            ...
            and enjoy the hospitality you deserve—only at <strong>Hotel Marble ARL.</strong>
      ...
      <div className="container-xxl py-5">
        ...
        <div className="hotel-spb-87">
          <h2 className="text-center">Request For <span>Hotel Marble ARL </span>Room Booking</h2>
