  ...
  <div className="container hotel-main">
   ...
   <div className="container hotel-main mt-5 mb-5">
        <div className="text-center">
          <h2 className="mb-3">About Hotel SPB-87 Delhi </h2>
          <div className="hotel-siam-line m-auto mb-3"></div>
          <p className="mx-auto" style={{ maxWidth: "1000px" }}>
           
            Welcome to <strong>Hotel SPB-87 Delhi </strong> by <strong>Tomar Hospitality</strong>, where comfort meets elegance. Located in the heart of the city,
            ...
            and enjoy the hospitality you deserve—only at <strong>Hotel SPB-87 Delhi.</strong>
      ...
      <div className="container-xxl py-5">
        ...
        <div className="hotel-spb-87">
          <h2 className="text-center">Request For <span>Hotel SPB-87 Delhi </span>Room Booking</h2>
