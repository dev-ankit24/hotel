...
export default function Gallery() {
  ...
  return (
    ...
    <div className="container-fluid page-header mb-1 p-0" style={{backgroundImage: "url(/img/room/deluxe/deluxe1.jpg)"}}>
        ...
        <h1 className="text-center" style={{color:"#B37E48"}}>Gallery</h1>
     {
        data.length?
