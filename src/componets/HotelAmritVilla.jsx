...
export default function HotelAmritVilla() {
 ...
 <div className="container hotel-main mt-5 mb-5">
        <div className="text-center">
          <h2 className="mb-3">About Hotel Amrit Villa</h2>
          <div className="hotel-siam-line m-auto mb-3"></div>
          <p className="mx-auto" style={{ maxWidth: "1000px" }}>
           
            Welcome to <strong>Hotel Amrit Villa</strong> by <strong>Tomar Hospitality</strong>, where comfort meets elegance. Located in the heart of the city,
            ...
            and enjoy the hospitality you deserve—only at <strong>Hotel Amrit Villa.</strong>
